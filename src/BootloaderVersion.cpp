...
uint32_t BootloaderVersion::Major() { return (BootloaderVersion::version >> 16u) & 0xff; }

uint32_t BootloaderVersion::Minor() { return (BootloaderVersion::version >> 8u) & 0xff; }

uint32_t BootloaderVersion::Patch() { return BootloaderVersion::version & 0xff; }

const char* BootloaderVersion::VersionString() { return BootloaderVersion::versionString; }

bool BootloaderVersion::IsValid() { return BootloaderVersion::version >= 0x00010000; }
