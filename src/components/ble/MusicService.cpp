...
namespace {
    ...
    constexpr ble_uuid128_t BaseUuid() { return CharUuid(0x00, 0x00); }
...
std::string Pinetime::Controllers::MusicService::getAlbum() const { return albumName; }

std::string Pinetime::Controllers::MusicService::getArtist() const { return artistName; }

std::string Pinetime::Controllers::MusicService::getTrack() const { return trackName; }

bool Pinetime::Controllers::MusicService::isPlaying() const { return playing; }

float Pinetime::Controllers::MusicService::getPlaybackSpeed() const { return playbackSpeed; }
...
int Pinetime::Controllers::MusicService::getTrackLength() const { return trackLength; }
