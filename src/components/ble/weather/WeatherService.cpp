    ...
    namespace Controllers {
        ...
        int WeatherService::OnCommand(struct ble_gatt_access_ctxt* ctxt) {
            if (ctxt->op == BLE_GATT_ACCESS_OP_WRITE_CHR) {
                ...
                UsefulBufC encodedCbor = {ctxt->om->om_data,
                                          OS_MBUF_PKTLEN(ctxt->om)}; // NOLINT(cppcoreguidelines-pro-bounds-pointer-arithmetic)
                ...
                switch (static_cast<WeatherData::eventtype>(tmpEventType)) {
                    ...
                    case WeatherData::eventtype::Temperature: {
                        ...
                        temperature->temperature = static_cast<int16_t>(
                          tmpTemperature); // NOLINT(bugprone-narrowing-conversions,cppcoreguidelines-narrowing-conversions)
                        ...
                        temperature->dewPoint = static_cast<int16_t>(
                          tmpDewPoint); // NOLINT(bugprone-narrowing-conversions,cppcoreguidelines-narrowing-conversions)
        ...
        size_t WeatherService::GetTimelineLength() const { return timeline.size(); }
