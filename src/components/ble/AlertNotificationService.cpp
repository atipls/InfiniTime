...
int AlertNotificationService::OnAlert(struct ble_gatt_access_ctxt* ctxt) {
    if (ctxt->op == BLE_GATT_ACCESS_OP_WRITE_CHR) {
        ...
        switch (category) {
            case Categories::Call: notif.category = Pinetime::Controllers::NotificationManager::Categories::IncomingCall; break;
            default: notif.category = Pinetime::Controllers::NotificationManager::Categories::SimpleAlert; break;
        }
