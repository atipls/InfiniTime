    ...
    namespace Controllers {
        class Settings {
          public:
            ...
            ChimesOption GetChimeOption() const { return settings.chimesOption; };
            ...
            Notification GetNotificationStatus() const { return settings.notificationStatus; };
            ...
            int16_t GetShakeThreshold() const { return settings.shakeWakeThreshold; }
            ...
            void setWakeUpMode(WakeUpMode wakeUp, bool enabled) {
                ...
                if (enabled) {
                    switch (wakeUp) {
                        case WakeUpMode::SingleTap: settings.wakeUpMode.set(static_cast<size_t>(WakeUpMode::DoubleTap), false); break;
                        case WakeUpMode::DoubleTap: settings.wakeUpMode.set(static_cast<size_t>(WakeUpMode::SingleTap), false); break;
                        default: break;
                    }
                }
            };

            std::bitset<4> getWakeUpModes() const { return settings.wakeUpMode; }
            ...
            void SetBleRadioEnabled(bool enabled) { bleRadioEnabled = enabled; };

            bool GetBleRadioEnabled() const { return bleRadioEnabled; };
