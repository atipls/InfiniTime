...
void St7789::WriteSpi(const uint8_t* data, size_t size) { spi.Write(data, size); }
...
void St7789::SleepOut() { WriteCommand(static_cast<uint8_t>(Commands::SleepOut)); }

void St7789::SleepIn() { WriteCommand(static_cast<uint8_t>(Commands::SleepIn)); }
...
void St7789::DisplayOn() { WriteCommand(static_cast<uint8_t>(Commands::DisplayOn)); }
...
void St7789::WriteToRam() { WriteCommand(static_cast<uint8_t>(Commands::WriteToRam)); }
