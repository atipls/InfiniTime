...
namespace {
    ...
    void user_delay(uint32_t period_us, void* /*intf_ptr*/) { nrf_delay_us(period_us); }
}
...
void Bma421::Read(uint8_t registerAddress, uint8_t* buffer, size_t size) { twiMaster.Read(deviceAddress, registerAddress, buffer, size); }
...
void Bma421::ResetStepCounter() { bma423_reset_step_counter(&bma); }
...
Bma421::DeviceTypes Bma421::DeviceType() const { return deviceType; }
