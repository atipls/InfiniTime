...
Twos::Twos() {
    ...
    static constexpr colorPair colors[nColors] = {
      {LV_COLOR_MAKE(0xcd, 0xc0, 0xb4), LV_COLOR_BLACK}, {LV_COLOR_MAKE(0xef, 0xdf, 0xc6), LV_COLOR_BLACK},
      {LV_COLOR_MAKE(0xef, 0x92, 0x63), LV_COLOR_WHITE}, {LV_COLOR_MAKE(0xf7, 0x61, 0x42), LV_COLOR_WHITE},
...
void Twos::updateGridDisplay() {
    for (unsigned int i = 0; i < nCells; i++) {
        ...
        switch (grid[row][col].value) {
            case 0: lv_table_set_cell_type(gridDisplay, row, col, 1); break;
            case 2:
            case 4: lv_table_set_cell_type(gridDisplay, row, col, 2); break;
            case 8:
            case 16: lv_table_set_cell_type(gridDisplay, row, col, 3); break;
            case 32:
            case 64: lv_table_set_cell_type(gridDisplay, row, col, 4); break;
            default: lv_table_set_cell_type(gridDisplay, row, col, 5); break;
        }
    }
}
